 ...
 */
final class Version20181210094606 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admin_header_landing_page (id INT AUTO_INCREMENT NOT NULL, landing_page_id INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A17DA1EDF122DC5 (landing_page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE admin_header_landing_page ADD CONSTRAINT FK_A17DA1EDF122DC5 FOREIGN KEY (landing_page_id) REFERENCES landign_page (id)');
        $this->addSql('ALTER TABLE header_landing_page_translation ADD CONSTRAINT FK_B25169432C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES admin_header_landing_page (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin_header_landing_page DROP FOREIGN KEY FK_A17DA1EDF122DC5');
        ...
        $this->addSql('DROP TABLE admin_header_landing_page');
